...
var MassNames = map[string]Unit{
	...
	"grain": {0, 0, grainToGram,
		UnitOfMass,
		"gr", "grain", "grains",
		"an imperial measure of mass (an apothecaries' measure)."},
	"troy-ounce": {0, 0, grainToGram * 480,
		UnitOfMass,
		"t oz", "troy ounce", "troy ounces",
		"an imperial measure of mass (an apothecaries' measure)."},
	"scruple": {0, 0, grainToGram * 20,
		UnitOfMass,
		"scruple", "scruple", "scruples",
		"an imperial measure of mass (an apothecaries' measure)."},
	"dram": {0, 0, grainToGram * 60,
		UnitOfMass,
		"dr", "dram", "drams",
		"an imperial measure of mass (an apothecaries' measure)."},
	"drachm": {0, 0, grainToGram * 60,
		UnitOfMass,
		"dr", "drachm", "drachms",
		"an imperial measure of mass (an apothecaries' measure)."},

	// Imperial / US
	"ounce": {0, 0, ounceToGram,
		UnitOfMass,
		"oz", "ounce", "ounces",
		"an imperial measure of mass."},
	"pound": {0, 0, poundToGram,
		UnitOfMass,
		"lb", "pound", "pounds",
		"an imperial measure of mass."},
	"stone": {0, 0, poundToGram * 14,
		UnitOfMass,
		"st", "stone", "stones",
		"an imperial measure of mass."},
	"hundredweight": {0, 0, poundToGram * 112,
		UnitOfMass,
