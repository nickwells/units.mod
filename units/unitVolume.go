...
var volumeAliases = map[string]Alias{
	"cc":                {"ml", ""},
	"cubic-centimetre":  {"ml", "hyphenated"},
	"cubic-centimetres": {"ml", "hyphenated, plural"},
	"cubic centimetre":  {"ml", ""},
	"cubic centimetres": {"ml", "plural"},
	"cubic-centimeter":  {"ml", "US spelling, hyphenated"},
	"cubic-centimeters": {"ml", "US spelling, hyphenated, plural"},
	"cubic centimeter":  {"ml", "US spelling"},
	"cubic centimeters": {"ml", "US spelling, plural"},
	"cubic-metre":       {"cubic metre", "hyphenated"},
	"cubic-metres":      {"cubic metre", "hyphenated, plural"},
	"cubic metres":      {"cubic metre", "plural"},
	"cubic-meter":       {"cubic metre", "US spelling, hyphenated"},
	"cubic-meters":      {"cubic metre", "US spelling, hyphenated, plural"},
	"cubic meter":       {"cubic metre", "US spelling"},
	"cubic meters":      {"cubic metre", "US spelling, plural"},
	"cubic kilometre":   {"Tl", ""},
	"cubic kilometres":  {"Tl", "plural"},
	"cubic-kilometre":   {"Tl", "hyphenated"},
	"cubic-kilometres":  {"Tl", "hyphenated, plural"},
	"cubic-kilometer":   {"Tl", "US spelling, hyphenated"},
	"cubic-kilometers":  {"Tl", "US spelling, hyphenated, plural"},
	"cubic kilometer":   {"Tl", "US spelling"},
	"cubic kilometers":  {"Tl", "US spelling, plural"},
	"liter":             {"litre", "US spelling"},
	"liters":            {"litre", "US spelling, plural"},
	"cubic-inch":        {"cubic inch", "hyphenated"},
	"cubic-inches":      {"cubic inch", "hyphenated, plural"},
	"cubic inches":      {"cubic inch", "plural"},
	"cubic-foot":        {"cubic foot", "hyphenated"},
	"cubic-feet":        {"cubic foot", "hyphenated, plural"},
	"cubic feet":        {"cubic foot", "plural"},
	"cubic-yard":        {"cubic yard", "hyphenated"},
	"cubic-yards":       {"cubic yard", "hyphenated, plural"},
	"cubic yards":       {"cubic yard", "plural"},
	"cup":               {"US-cup", ""},
	"cups":              {"US-cup", "plural"},
}
