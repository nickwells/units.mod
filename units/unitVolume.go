...
var VolumeNames = map[string]Unit{
	...
	"cc": {0, 0, m * 1e-3,
		UnitOfVolume,
		"cc", "cubic centimetre", "cubic centimetres", "a metric measure of volume"},
	...
	"cubic-kilometre": {0, 0, _G,
		UnitOfVolume,
		"km\u00B3", "cubic kilometre", "cubic kilometres", "a metric measure of volume"},
	"cubic kilometre": {0, 0, _G,
		UnitOfVolume,
		"km\u00B3", "cubic kilometre", "cubic kilometres", "a metric measure of volume"},
	...
	// Imperial / US
	"cubic-inch": {0, 0, (inchToMetre * inchToMetre * inchToMetre),
		UnitOfVolume,
	...
	"cubic inch": {0, 0, (inchToMetre * inchToMetre * inchToMetre),
		...
		"in\u00B3", "cubic inch", "cubic inches",
		"an imperial measure of volume"},
	"cubic-foot": {0, 0, (footToMetre * footToMetre * footToMetre),
		UnitOfVolume,
	...
	"cubic foot": {0, 0, (footToMetre * footToMetre * footToMetre),
		...
		"ft\u00B3", "cubic foot", "cubic feet",
		"an imperial measure of volume"},
	"cubic-yard": {0, 0, (yardToMetre * yardToMetre * yardToMetre),
		UnitOfVolume,
